...
git clone https://github.com/Sanjis-Android-Playground/vendor_xiaomi_sm8250-common.git vendor/xiaomi/sm8250-common
git clone https://github.comSanjis-Android-Playground/vendor_xiaomi_alioth.git vendor/xiaomi/alioth
...
git clone https://github.com/Sanjis-Android-Playground/hardware_xiaomi.git hardware/xiaomi
